...
// Register the command to show the timer in a Webview panel
let showTimerCommand = vscode.commands.registerCommand('timer.show', () => {
  ...
  // Otherwise, create a new panel and set its content
